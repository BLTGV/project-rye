...
interface another area calls. `scripts/gen-agents`, `agents/`, `work/`, and
...
- publishes: contracts/sql-surface.md contracts/rye-cli.md contracts/docs-content.md
...
- consumes: contracts/sql-surface.md contracts/rye-cli.md contracts/admin-api.md
...
- consumes: contracts/sql-surface.md
