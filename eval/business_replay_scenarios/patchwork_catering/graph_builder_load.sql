...
BEGIN
    ...
    PERFORM record_assertion('deal_value', jsonb_build_object('amount', 18600, 'currency', 'USD', 'source', 'SME correction from old spreadsheet value'), v_atlas_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, 1.0, 'accepted', 'assumed', NULL, NULL, jsonb_build_object('source', 'rye-crm'));
    PERFORM record_assertion('win_probability', jsonb_build_object('probability', 0.60, 'source', 'SME correction from old spreadsheet probability'), v_atlas_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, 1.0, 'accepted', 'assumed', NULL, NULL, jsonb_build_object('source', 'rye-crm'));
    PERFORM record_assertion('next_sales_action', jsonb_build_object('next_action', 'Send revised vegetarian station pricing by 2026-06-24'), v_atlas_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, 1.0, 'accepted', 'assumed', NULL, NULL, jsonb_build_object('source', 'rye-crm'));

    PERFORM record_assertion('deal_value', jsonb_build_object('amount', 32000, 'currency', 'USD', 'source', 'SME-confirmed tentative value'), v_willow_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, 1.0, 'accepted', 'assumed', NULL, NULL, jsonb_build_object('source', 'rye-crm'));
    PERFORM record_assertion('win_probability', jsonb_build_object('probability', 0.45, 'source', 'SME-confirmed cap until kitchen access and headcount are known'), v_willow_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, 1.0, 'accepted', 'assumed', NULL, NULL, jsonb_build_object('source', 'rye-crm'));
    PERFORM record_assertion('next_sales_action', jsonb_build_object('next_action', 'Complete River Hall site walk and confirm kitchen access on 2026-06-27'), v_willow_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, 1.0, 'accepted', 'assumed', NULL, NULL, jsonb_build_object('source', 'rye-crm'));

    PERFORM record_assertion('deal_value', jsonb_build_object('amount', 7800, 'currency', 'USD', 'source', 'SME-confirmed rough value'), v_baxter_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, 1.0, 'accepted', 'assumed', NULL, NULL, jsonb_build_object('source', 'rye-crm'));
    PERFORM record_assertion('win_probability', jsonb_build_object('probability', 0.30, 'source', 'SME-confirmed low-confidence inquiry'), v_baxter_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, 1.0, 'accepted', 'assumed', NULL, NULL, jsonb_build_object('source', 'rye-crm'));
    PERFORM record_assertion('next_sales_action', jsonb_build_object('next_action', 'Ask Jenna whether they want dessert only or dessert plus coffee service by 2026-06-25'), v_baxter_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, 1.0, 'accepted', 'assumed', NULL, NULL, jsonb_build_object('source', 'rye-crm'));
    ...
    PERFORM record_assertion('milestone_status', jsonb_build_object('status', 'waiting_customer', 'reason', 'Waiting on Priya approval and deposit follow-up.'), v_atlas_contract_milestone, NULL, 'default', '2026-06-22T12:00:00Z', NULL, 1.0, 'accepted', 'assumed', NULL, NULL, jsonb_build_object('source', 'rye-project-management'));
    PERFORM record_assertion('milestone_status', jsonb_build_object('status', 'planned', 'reason', 'Site walk planned for June 27.'), v_willow_site_milestone, NULL, 'default', '2026-06-22T12:00:00Z', NULL, 1.0, 'accepted', 'assumed', NULL, NULL, jsonb_build_object('source', 'rye-project-management'));
    PERFORM record_assertion('milestone_status', jsonb_build_object('status', 'pending_site_walk', 'reason', 'Proposal decision waits on headcount and kitchen access.'), v_willow_proposal_milestone, NULL, 'default', '2026-06-22T12:00:00Z', NULL, 1.0, 'accepted', 'assumed', NULL, NULL, jsonb_build_object('source', 'rye-project-management'));
    ...
    v_candidate := create_knowledge_candidate('decision', 'Old Lead Tracker value for Atlas was $17,800 and old probability was 55%.', jsonb_build_object('record_type', 'opportunity', 'opportunity_id', v_atlas_opp), ARRAY[v_scope], 'patchwork-reject-old-atlas-forecast', 'patchwork-clean-intake', ARRAY[v_leads_sheet], '{}', 0.85);
    ...
    v_candidate := create_knowledge_candidate('decision', 'Project task decision: Crest response after revised tent dimensions is still pending for Atlas rentals confirmation.', jsonb_build_object('record_type', 'decision', 'task_id', v_atlas_rentals_task), ARRAY[v_scope], 'patchwork-pending-crest-response', 'patchwork-clean-intake', ARRAY[v_atlas_email], '{}', 0.9);
