...
BEGIN
    ...
    PERFORM record_assertion('deal_value', jsonb_build_object('amount', 44800, 'currency', 'USD', 'source', 'Dana correction after Northstar maple cabinet allowance'), v_harper_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, NULL, 1.0, 'current', NULL, jsonb_build_object('source', 'rye-crm'));
    PERFORM record_assertion('win_probability', jsonb_build_object('probability', 0.65, 'source', 'Dana correction after cabinet change'), v_harper_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, NULL, 1.0, 'current', NULL, jsonb_build_object('source', 'rye-crm'));
    PERFORM record_assertion('next_sales_action', jsonb_build_object('next_action', 'Send revised Northstar maple cabinet allowance by 2026-06-24'), v_harper_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, NULL, 1.0, 'current', NULL, jsonb_build_object('source', 'rye-crm'));
    PERFORM record_assertion('deal_value', jsonb_build_object('amount', 96000, 'currency', 'USD', 'source', 'Leads and Job Board row'), v_vale_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, NULL, 1.0, 'current', NULL, jsonb_build_object('source', 'rye-crm'));
    PERFORM record_assertion('win_probability', jsonb_build_object('probability', 0.35, 'source', 'Leads and Job Board row'), v_vale_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, NULL, 1.0, 'current', NULL, jsonb_build_object('source', 'rye-crm'));
    PERFORM record_assertion('next_sales_action', jsonb_build_object('next_action', 'Send zoning feasibility questions to City of Millbrook by 2026-06-26'), v_vale_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, NULL, 1.0, 'current', NULL, jsonb_build_object('source', 'rye-crm'));
    PERFORM record_assertion('deal_value', jsonb_build_object('amount', 8400, 'currency', 'USD', 'source', 'Olson email and spreadsheet'), v_olson_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, NULL, 1.0, 'current', NULL, jsonb_build_object('source', 'rye-crm'));
    PERFORM record_assertion('win_probability', jsonb_build_object('probability', 0.75, 'source', 'Leads and Job Board row'), v_olson_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, NULL, 1.0, 'current', NULL, jsonb_build_object('source', 'rye-crm'));
    PERFORM record_assertion('next_sales_action', jsonb_build_object('next_action', 'Send insurance-ready estimate by 2026-06-23'), v_olson_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, NULL, 1.0, 'current', NULL, jsonb_build_object('source', 'rye-crm'));
    PERFORM record_assertion('deal_value', jsonb_build_object('amount', 18000, 'currency', 'USD', 'source', 'Stale lead sheet value retained but status corrected'), v_garza_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, NULL, 1.0, 'current', NULL, jsonb_build_object('source', 'rye-crm'));
    PERFORM record_assertion('next_sales_action', jsonb_build_object('next_action', 'Follow up with Tom Garza on 2026-07-15 about August timing'), v_garza_opp, NULL, 'default', '2026-06-22T12:00:00Z', NULL, NULL, 1.0, 'current', NULL, jsonb_build_object('source', 'rye-crm'));
    ...
    PERFORM record_assertion('milestone_status', jsonb_build_object('status', 'waiting_customer', 'reason', 'Waiting on Sarah approval of revised cabinet allowance and deposit.'), v_harper_contract_milestone, NULL, 'default', '2026-06-22T12:00:00Z', NULL, NULL, 1.0, 'current', NULL, jsonb_build_object('source', 'rye-project-management'));
    PERFORM record_assertion('milestone_status', jsonb_build_object('status', 'waiting_city', 'reason', 'Waiting on City feasibility answer before proposal.'), v_vale_proposal_milestone, NULL, 'default', '2026-06-22T12:00:00Z', NULL, NULL, 1.0, 'current', NULL, jsonb_build_object('source', 'rye-project-management'));
    PERFORM record_assertion('milestone_status', jsonb_build_object('status', 'waiting_customer_deposit', 'reason', 'Waiting on Megan approval and deposit.'), v_olson_booked_milestone, NULL, 'default', '2026-06-22T12:00:00Z', NULL, NULL, 1.0, 'current', NULL, jsonb_build_object('source', 'rye-project-management'));
    PERFORM record_assertion('milestone_status', jsonb_build_object('status', 'tentative', 'reason', 'Crew window is tentative until deposit lands.'), v_olson_crew_milestone, NULL, 'default', '2026-06-22T12:00:00Z', NULL, NULL, 1.0, 'current', NULL, jsonb_build_object('source', 'rye-project-management'));
    ...
    FOREACH v_candidate IN ARRAY ARRAY[
        ...
        create_knowledge_candidate('fact', 'Harper Lane kitchen remodel is Leo-owned, proposal sent, value $44,800, probability 65%, with revised Northstar maple allowance due June 24.', jsonb_build_object('record_type', 'opportunity', 'opportunity_id', v_harper_opp), ARRAY[v_scope], 'millbrook-harper-opportunity', 'millbrook-clean-intake', ARRAY[v_slack, v_harper_email, v_leads_sheet], '{}', 0.95),
        create_knowledge_candidate('fact', 'Vale backyard ADU feasibility is Dana-owned, qualification stage, value $96,000, probability 35%, and waits on City feasibility answer.', jsonb_build_object('record_type', 'opportunity', 'opportunity_id', v_vale_opp), ARRAY[v_scope], 'millbrook-vale-opportunity', 'millbrook-clean-intake', ARRAY[v_slack, v_vale_email, v_leads_sheet], '{}', 0.94),
        create_knowledge_candidate('fact', 'Olson bathroom leak repair has site survey complete, value $8,400, probability 75%, with insurance-ready estimate due June 23.', jsonb_build_object('record_type', 'opportunity', 'opportunity_id', v_olson_opp), ARRAY[v_scope], 'millbrook-olson-opportunity', 'millbrook-clean-intake', ARRAY[v_slack, v_olson_email, v_leads_sheet], '{}', 0.94),
        create_knowledge_candidate('fact', 'Garza deck replacement is paused or nurture, not closed lost, with Leo follow-up on July 15.', jsonb_build_object('record_type', 'opportunity', 'opportunity_id', v_garza_opp), ARRAY[v_scope], 'millbrook-garza-opportunity', 'millbrook-clean-intake', ARRAY[v_slack, v_leads_sheet], '{}', 0.9)
    ] LOOP
        PERFORM set_candidate_status(v_candidate, 'accepted', 'Accepted by simulated Dana/Leo SME review.', 'millbrook-sme');
    END LOOP;

    v_candidate := create_knowledge_candidate('fact', 'Old Leads and Job Board value for Harper was $42,000 and old probability was 55%.', jsonb_build_object('record_type', 'opportunity', 'opportunity_id', v_harper_opp), ARRAY[v_scope], 'millbrook-reject-old-harper-forecast', 'millbrook-clean-intake', ARRAY[v_leads_sheet], '{}', 0.86);
    ...
    v_candidate := create_knowledge_candidate('fact', 'Garza deck replacement is closed lost with 0% probability.', jsonb_build_object('record_type', 'opportunity', 'opportunity_id', v_garza_opp), ARRAY[v_scope], 'millbrook-reject-garza-closed-lost', 'millbrook-clean-intake', ARRAY[v_leads_sheet], '{}', 0.75);
    ...
    v_candidate := create_knowledge_candidate('fact', 'Olson July 8 crew hold is schedule locked because Deposit Tracker says Checked?.', jsonb_build_object('record_type', 'task', 'task_id', v_olson_crew_task), ARRAY[v_scope], 'millbrook-reject-olson-locked-crew-hold', 'millbrook-clean-intake', ARRAY[v_deposit_sheet], '{}', 0.72);
    ...
    v_candidate := create_knowledge_candidate('fact', 'Project task decision: Northstar written cabinet quote is still pending for Harper cabinet allowance revision.', jsonb_build_object('record_type', 'decision', 'task_id', v_harper_cabinet_task), ARRAY[v_scope], 'millbrook-pending-northstar-quote', 'millbrook-clean-intake', ARRAY[v_slack, v_harper_email], '{}', 0.9);
    PERFORM set_candidate_status(v_candidate, 'needs_review', 'Needs vendor written quote before final allowance.', 'millbrook-sme');
    v_candidate := create_knowledge_candidate('fact', 'Vale decision: City of Millbrook feasibility answer for detached ADU under 650 sqft is still pending.', jsonb_build_object('record_type', 'decision', 'opportunity_id', v_vale_opp, 'task_id', v_vale_city_task, 'milestone_id', v_vale_proposal_milestone), ARRAY[v_scope], 'millbrook-pending-city-feasibility', 'millbrook-clean-intake', ARRAY[v_slack, v_vale_email], '{}', 0.92);
    PERFORM set_candidate_status(v_candidate, 'needs_review', 'Needs City answer before Vale can move to proposal.', 'millbrook-sme');
    v_candidate := create_knowledge_candidate('fact', 'Olson decision: Megan estimate approval and deposit are still pending before booking and schedule lock.', jsonb_build_object('record_type', 'decision', 'opportunity_id', v_olson_opp, 'task_id', v_olson_deposit_task, 'milestone_id', v_olson_booked_milestone), ARRAY[v_scope], 'millbrook-pending-olson-approval-deposit', 'millbrook-clean-intake', ARRAY[v_slack, v_olson_email, v_deposit_sheet], '{}', 0.9);
    PERFORM set_candidate_status(v_candidate, 'needs_review', 'Needs customer approval and deposit before booking.', 'millbrook-sme');
    v_candidate := create_knowledge_candidate('fact', 'Garza decision: Tom Garza still needs to confirm whether August timing is real.', jsonb_build_object('record_type', 'decision', 'opportunity_id', v_garza_opp, 'task_id', v_garza_followup_task), ARRAY[v_scope], 'millbrook-pending-garza-august-timing', 'millbrook-clean-intake', ARRAY[v_slack], '{}', 0.86);
